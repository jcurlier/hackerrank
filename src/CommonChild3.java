...
public class CommonChild3 {
	public final static boolean DEBUG = false;
	
	private static String clean1;
	private static String clean2;
    ...
    private static String Solve(String s1, String s2) {
    	...
    	clean1 = clean(s1, alphabet);
    	clean2 = clean(s2, alphabet);
    ...
    private static String run(int index1, int index2, String str) {
		...
		if (pos >= 0) {
    		...
    		// take it
			str1 = run(index1 + 1, index2 + pos + 1, str + c);
